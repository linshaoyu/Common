...
import cn.common.core.utils.ShellUtils.CommandResult;
...
* 类描述：   包的安装帮助类
* 创建人：Administrator   
* 创建时间：2014-4-9 下午4:04:03   
* 修改人：Administrator   
* 修改时间：2014-4-9 下午4:04:03   
* 修改备注：   包含静默安装
* @version    
*
 */
public class PackageUtils {
     ...
     * 静默安装
     * <ul>
     * <li>如果是系统应用或者已经root{@link #installSilent(Context, String)}</li>
     * <li>否则正常安装{@link #installNormal(Context, String)}</li>
     * </ul>
     * @param context 上下文
     * @param filePath 文件路径
     * @return
     ...
     * <ul>
     * <strong>注意:</strong>
     * <li>不要在UI线程中调用此方法，因为本方法是耗时操作</li>
     * <li>你需要添加 <strong>android.permission.INSTALL_PACKAGES</strong> 在manifest清单中, 如果你安装的是系统app这样就不需要去请求root权限</li>
     * <li>默认 pm安装参数是"-r".</li>
     * </ul>
     * 
     * @param context
     * @param filePath  文件路径
     * @return {@link PackageUtils#INSTALL_SUCCEEDED} 意味着安装成功, 反之失败.详细信息请看
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        /**
         * 如果context是系统app，不需要root权限，但是需要在清单文件中添加<uses-permission
         * android:name="android.permission.INSTALL_PACKAGES" /> 权限
         **/
     ...
     * 根据条件卸载
     * <ul>
     * <li>如果是系统app或者已经root, 请查看 {@link #uninstallSilent(Context, String)}</li>
     * <li>否则请查看 {@link #uninstallNormal(Context, String)}</li>
     * </ul>
     * 
     * @param context 上下文
     ...
     * <ul>
     * <strong>注意:</strong>
     * <li>本方法是耗时操作，请勿在UI线程中操作</li>
     * <li>需要再清单文件中添加 <strong>android.permission.DELETE_PACKAGES</strong>权限，如果是系统app执行此操作时，就不需要去请求root权限
     * permission, if you are system app.</li>
     * </ul>
     * 
     * @param context 
     * @param packageName 
     * @param app卸载之后是否保留现有app数据
     * @return <ul>
     * <li>{@link #DELETE_SUCCEEDED} 卸载成功</li>
     * <li>{@link #DELETE_FAILED_INTERNAL_ERROR} 内部出错</li>
     * <li>{@link #DELETE_FAILED_INVALID_PACKAGE} 包名出错</li>
     * <li>{@link #DELETE_FAILED_PERMISSION_DENIED} 权限被禁止</li>
     */
    public static int uninstallSilent(Context context, String packageName, boolean isKeepData) {
        ...
        /**
         * 如果是系统app, 不需要root权限, 但需要在清单中添加 <uses-permission
     ...
     * <ul>
     * <strong>注意:</strong>
     * <li>你需要在清单文件中添加 <strong>android.permission.GET_TASKS</strong></li>
     * </ul>
     * 
     * @param context
     * @param packageName
     * @return  如果参数错误或者任务栈为空，返回null，否则都会返回app的任务在栈顶
     */
